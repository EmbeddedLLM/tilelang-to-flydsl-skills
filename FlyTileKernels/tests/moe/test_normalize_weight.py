...
from fly_fly_tile_kernels.testing.generator import generate_topk_idx, generate_moe_params
from fly_fly_tile_kernels.testing.numeric import assert_equal, count_bytes
from fly_fly_tile_kernels.torch import normalize_weight as torch_normalize_weight
...
def test_normalize_weight(params):
    ...
    denominator, normalized_weights = fly_tile_kernels.moe.normalize_weight(topk_weights)
...
def test_normalize_weight_benchmark(benchmark_timer, benchmark_record, params):
    ...
    t_us = benchmark_timer(lambda: fly_tile_kernels.moe.normalize_weight(topk_weights))
