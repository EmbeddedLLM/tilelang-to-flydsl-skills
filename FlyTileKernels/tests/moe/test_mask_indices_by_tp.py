...
def test_mask_indices_by_tp(params):
    ...
    masked_indices = fly_tile_kernels.moe.mask_indices_by_tp(topk_idx, n, num_ep_ranks, tp_rank, num_tp_ranks)
...
def test_mask_indices_by_tp_benchmark(benchmark_timer, benchmark_record, params):
    ...
    t_us = benchmark_timer(lambda: fly_tile_kernels.moe.mask_indices_by_tp(topk_idx, n, num_ep_ranks, tp_rank, num_tp_ranks))
