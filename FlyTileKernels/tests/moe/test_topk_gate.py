...
from fly_fly_tile_kernels.torch import stable_topk as torch_stable_topk
...
def test_topk_gate(params):
    ...
    topk_idx = fly_tile_kernels.moe.topk_gate(scores, num_topk)
...
def test_topk_gate_benchmark(benchmark_timer, benchmark_record, params):
    ...
    t_us = benchmark_timer(lambda: fly_tile_kernels.moe.topk_gate(scores, num_topk))
