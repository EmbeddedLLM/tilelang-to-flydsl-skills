...
from fly_fly_tile_kernels.testing.generator import generate_hidden_sizes, generate_num_tokens, generate_e5m6_inputs
from fly_fly_tile_kernels.testing.numeric import assert_equal, calc_diff, count_bytes
from fly_fly_tile_kernels.torch import cast_back_from_e5m6
...
def generate_test_data(params):
    ...
    x_e5m6, x_sf = fly_tile_kernels.quant.per_token_cast(
    ...
    func = lambda: fly_tile_kernels.quant.cast_back((x_e5m6, x_sf), out_dtype_str, (1, hidden), x_special_fmt='e5m6')
