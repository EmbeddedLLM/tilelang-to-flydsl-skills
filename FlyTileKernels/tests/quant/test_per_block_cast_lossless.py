...
from fly_fly_tile_kernels.testing.generator import generate_hidden_sizes, generate_num_tokens, generate_rand_float
...
def generate_test_data(params):
    ...
    x = clamp_abs_ratio(x)
    x_fp4 = fly_tile_kernels.torch.cast(
    ...
    cast_func = lambda: fly_tile_kernels.quant.per_block_cast_lossless(
        x_fp4, 'e4m3',
...
def test_per_block_cast_lossless(params):
    ...
    x_fp8_fp32_ref = fly_tile_kernels.torch.cast_back(x_fp4, 'fp32', (in_sf_block_m, in_sf_block_k))
    x_fp8_fp32 = fly_tile_kernels.torch.cast_back(x_fp8, 'fp32', (out_sf_block_m, out_sf_block_k))
